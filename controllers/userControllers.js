...
let mailOptions = {
    ...
    <tbody>
      ...
      <tr>
        <td colspan="2"><h2 style="color: rgba(0, 0, 0, 0.79); font-size: 1rem; text-align: center;">Please click <a style="color: rgba(0, 0, 0, 0.557);" <a href="https://http://localhost:4000/api/verify/${uniqueString}">here</a> to confirm your email adress.</h2></td>
      </tr>
    </tbody>
    </table>`
}
